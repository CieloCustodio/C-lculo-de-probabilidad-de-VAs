...
```
 ...
 las ondas cambian de tamaño 
 
 d. ¿Qué efecto tiene $p$ en la asimetría?
 la grafica estara mas deforme
...
Tanto `R` como `python`  permiten calcular integrales usando los comandos básicos o bién usando sistemas de cómputo algebraíco. R, por ejemplo, puede utilizar un sistema llamado `Ryacas` que permite hacer muchos cálculos de forma simbólica. Ahora, consideremos que tenemos la siguiente PDF:
